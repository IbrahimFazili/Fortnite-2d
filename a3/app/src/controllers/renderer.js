...
export function showDebugInfo(debugDiv, stage, mousePos, frametime, ping) {
	debugDiv.empty();
	...
	frametime > 0 && debugDiv.append(`<span>FPS: ${Math.round(1000 / frametime)} (${frametime.toFixed(2)} ms)</span><br>`);
	debugDiv.append(`<span>Ping: ${ping} ms </span><br><br>`)
